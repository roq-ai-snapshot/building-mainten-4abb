...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('cost', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'Cost',
          header: 'Cost',
          accessorKey: 'Cost',
          cell: ({ row: { original: record } }: any) => (
            <Link as={NextLink} onClick={(e) => e.stopPropagation()} href={`/costs/view/${record.Cost?.id}`}>
              {record.Cost?.material_usage_details}
            </Link>
          ),
        }
      : null,
