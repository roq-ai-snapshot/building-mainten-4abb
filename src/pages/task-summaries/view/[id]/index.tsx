...
import { getTaskSummaryById } from 'apiSdk/task-summaries';
import { TaskSummaryInterface } from 'interfaces/task-summary';

function TaskSummaryViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('task_summary', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/task-summaries/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Task Summaris" text={data?.task_summaris} />
              </List>
            </FormWrapper>
          </>
        )}
